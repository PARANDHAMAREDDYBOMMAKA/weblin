  ...
  const distros = [
    {
      ...
      name: 'TinyCore Linux',
      description: 'Ultra-lightweight, fastest boot time (32-bit)',
      size: '~23MB',
      recommended: true,
      speed: 'Fastest',
    },
    {
      id: 'alpine' as const,
      name: 'Alpine Linux',
      description: 'Lightweight, security-oriented (32-bit)',
      size: '~52MB',
      recommended: false,
      speed: 'Fast',
    },
    {
      id: 'debian' as const,
      name: 'Debian 13',
      description: 'Stable and full-featured (32-bit)',
      size: '~350MB',
      recommended: false,
      speed: 'Moderate',
    },
    {
      ...
      description: 'Classic tiny distro with GUI (32-bit)',
      size: '~50MB',
      recommended: false,
      speed: 'Fast',
    },
