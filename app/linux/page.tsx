  ...
  const distros = [
    {
      ...
      name: 'TinyCore CorePlus',
      description: 'Lightweight with GUI desktop (FLWM/FLTK)',
      size: '~248MB',
      recommended: true,
      speed: 'Fast',
    },
    {
      id: 'alpine' as const,
      name: 'Puppy Linux',
      description: 'Small, fast, full-featured GUI desktop',
      size: '~320MB',
      recommended: false,
      speed: 'Fast',
    },
    {
      id: 'debian' as const,
      name: 'Debian 13 XFCE',
      description: 'Full desktop environment with XFCE',
      size: '~2.9GB',
      recommended: false,
      speed: 'Slow',
    },
    {
      ...
      description: 'Classic tiny distro with GUI desktop',
      size: '~50MB',
      recommended: false,
      speed: 'Fastest',
    },
